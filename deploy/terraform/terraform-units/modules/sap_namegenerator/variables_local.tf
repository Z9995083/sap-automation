...
variable "resource_suffixes" {
  ...
  default = {
    ...
    "storage_private_link_install"   = "-install-storage-privatelink"
    "storage_private_svc_install"    = "-install-storage-privateservice"
    ...
    "storage_private_link_transport" = "-transport-storage-privatelink"
    "storage_private_svc_transport"  = "-transport-storage-privateservice"
